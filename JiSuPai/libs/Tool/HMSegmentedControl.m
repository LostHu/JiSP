...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            return CGRectMake(x + self.selectionIndicatorEdgeInsets.left-10, indicatorYOffset, sectionWidth - self.selectionIndicatorEdgeInsets.right+20, self.selectionIndicatorHeight);
        } else {
